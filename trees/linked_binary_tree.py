...
class LinkedBinaryTree(BinaryTree):
    ...
    | sibling, children, num_children | O(1)
    | is_root, is_leaf                | O(1)
    | depth(p)                        | O(dₚ + 1)
    | height                          | O(n)
    | add_root, add_left, add_right   | O(1)
    | _replace, _delete, _attach      | O(1)
     ------------------------------------------------
    """
    ...
    def _add_left(self, p, e):
        """
        Create a new leaf child for Position p, storing element e

        Return the Position of new node
        Raise ValueError if p is invalid or p already has a left child
        """
        node = self._validate(p)
    ...
    def _add_right(self, p, e):
        ...
        Return the Position of new node
        Raise ValueError if p is invalid or it already has a right child
        """
        node = self._validate(p)
    ...
    def _delete(self, p):
        """
        Delete the node at position p, and replacet it with its child, if any
